...
import com.as.service.hims.MasterOtherMasters1_Department_Service;
import com.as.utils.ApiValidationUtility;

@RestController
@RequestMapping("/department_master")
@CrossOrigin(origins = "*", maxAge = 3600)
public class MasterOtherMasters1_Department_Controller {
	
	@Autowired
	MasterOtherMasters1_Department_Service service;
	
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PostMapping("/save")
	public BaseResponse save(@RequestBody MasterOtherMasters1_Department_DTO form,
	...
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PutMapping("/update")
	public BaseResponse update(@RequestBody MasterOtherMasters1_Department_DTO form, Principal principal, @RequestHeader("yearCd") Long yearCd) {
