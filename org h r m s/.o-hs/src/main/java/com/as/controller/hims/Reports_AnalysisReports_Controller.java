...
import com.as.service.hims.Reports_AnalysisReports_Service;

@RestController
@RequestMapping("/report-analysis_reports")
@CrossOrigin(origins = "*", maxAge = 3600)
public class Reports_AnalysisReports_Controller {

	@Autowired
	Reports_AnalysisReports_Service service;
	...
	@ResponseBody
	public BaseResponse getReport(@RequestBody Report_Bill_Request form,@RequestHeader("yearCd") Long yearCd) {
			return service.getReport(form,yearCd);
	}
