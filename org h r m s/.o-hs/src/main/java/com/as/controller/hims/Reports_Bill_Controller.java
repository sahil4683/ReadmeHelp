...
import com.as.service.hims.Reports_Bill_Service;

@RestController
@RequestMapping("/report-register_report-bill")
@CrossOrigin(origins = "*", maxAge = 3600)
public class Reports_Bill_Controller {

	@Autowired
	Reports_Bill_Service service;
