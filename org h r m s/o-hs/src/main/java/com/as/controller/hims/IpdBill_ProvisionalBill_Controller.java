...
import com.as.service.hims.IpdBill_ProvisionalBill_Service;
import com.as.utils.ApiValidationUtility;

@RestController
@RequestMapping("/provisional-bill")
@CrossOrigin(origins = "*", maxAge = 3600)
public class IpdBill_ProvisionalBill_Controller {

	
	@Autowired
	IpdBill_ProvisionalBill_Service service;
	
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PostMapping("/save")
	public BaseResponse save(@RequestBody IpdBill_ProvisionalBill_DTO form,
	...
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PutMapping("/update")
	public BaseResponse update(@RequestBody IpdBill_ProvisionalBill_DTO form, Principal principal, @RequestHeader("yearCd") Long yearCd) {
		BaseResponse response =  new ApiValidationUtility().validateAPI(form);
		if(response.getStatus() == 300) {
			return response;
		}
