...
import com.as.service.hims.MasterOtherMasters1_Concession_Service;
import com.as.utils.ApiValidationUtility;

@RestController
@RequestMapping("/master-other_masters1-concession")
@CrossOrigin(origins = "*", maxAge = 3600)
public class MasterOtherMasters1_Concession_Controller {
	
	@Autowired
	MasterOtherMasters1_Concession_Service service;
	
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PostMapping("/save")
	public BaseResponse save(@RequestBody MasterOtherMasters1_Concession_DTO form,
	...
	@PreAuthorize("hasAnyRole('ADMIN','USER')")
	@PutMapping("/update")
	public BaseResponse update(@RequestBody MasterOtherMasters1_Concession_DTO form, Principal principal, @RequestHeader("yearCd") Long yearCd) {
