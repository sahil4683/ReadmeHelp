...
export class ReceiptComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle("OHIMS | Receipt & Advance");
    this.tokenStorageService.setSessionPrivileges('hm_3_1_1');
    window.scrollTo(0, 0);
  ...
  getNextNumberSequence():void{
    this.tokenStorageService.getNextNumberSequence('Receipt').subscribe(
      data => {
        this.form.receiptNo = data.body;
      },
      err => {
        console.error(err);
      }
