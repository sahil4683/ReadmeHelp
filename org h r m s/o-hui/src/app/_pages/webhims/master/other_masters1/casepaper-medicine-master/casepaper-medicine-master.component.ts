...
import { CasepaperMedicineMasterService } from 'src/app/_service/webhims/master/other_masters1/casepaper-medicine-master.service';
...
export class CasepaperMedicineMasterComponent implements OnInit {
  ...
  constructor(private service: CasepaperMedicineMasterService,
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_6_18');
    window.scrollTo(0, 0);
    this.onTable();
  }
