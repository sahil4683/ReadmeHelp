...
import { ExternalLabMasterService } from 'src/app/_service/webhims/master/other_masters1/external-lab-master.service';
import { TokenStorageService } from 'src/app/_services/token-storage.service';
import { ComponentReloadService } from 'src/app/_helpers/component-reload.service';

@Component({
  selector: 'app-external-lab-master',
  templateUrl: './external-lab-master.component.html',
  styleUrls: ['./external-lab-master.component.css']
})
export class ExternalLabMasterComponent implements OnInit {

  constructor(private service:ExternalLabMasterService,
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_7_9');
    window.scrollTo(0, 0);
    this.onTable()
  }
