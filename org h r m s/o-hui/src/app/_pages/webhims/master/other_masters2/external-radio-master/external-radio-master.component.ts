...
import { ExternalRadioMasterService } from 'src/app/_service/webhims/master/other_masters1/external-radio-master.service';
...
export class ExternalRadioMasterComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_7_10');
    window.scrollTo(0, 0);
    this.onTable();
  }
