...
@Component({
  selector: 'app-patient-type-matser',
  templateUrl: './patient-type-matser.component.html',
  styleUrls: ['./patient-type-matser.component.css']
})
export class PatientTypeMatserComponent implements OnInit {

  constructor(private service: MasterCategoryService,
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_7_7');
  ...
  onTable(): void {
    ...
    this.service.getCategoryList('PATIENT TYPE').subscribe(
      data => {
        setTimeout(() =>
