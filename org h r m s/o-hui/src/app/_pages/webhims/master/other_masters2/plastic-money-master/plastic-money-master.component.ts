...
@Component({
  selector: 'app-plastic-money-master',
  templateUrl: './plastic-money-master.component.html',
  styleUrls: ['./plastic-money-master.component.css']
})
export class PlasticMoneyMasterComponent implements OnInit {

  constructor(private service: PlasticMoneyMasterService,
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_7_6');
    window.scrollTo(0, 0);
    this.onTable();
  }
