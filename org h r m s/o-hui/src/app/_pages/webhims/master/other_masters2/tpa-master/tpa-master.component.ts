...
@Component({
  selector: 'app-tpa-master',
  templateUrl: './tpa-master.component.html',
  styleUrls: ['./tpa-master.component.css']
})
export class TpaMasterComponent implements OnInit {

  constructor(private service: TpaMasterService,
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_7_2');
    window.scrollTo(0, 0);
    this.onTable();
  }
