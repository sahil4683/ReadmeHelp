...
import { OpdPackageMasterService } from 'src/app/_service/webhims/master/package_master/opd-package-master.service';
...
export class OpdPackageMasterComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.tokenStorageService.setSessionPrivileges('hm_5_5_2');
    window.scrollTo(0, 0);
    this.onTable();
