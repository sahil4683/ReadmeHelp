...
export class LabComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle("OHIMS | Lab Bill");
    this.tokenStorageService.setSessionPrivileges('hm_1_2_3');
    window.scrollTo(0, 0);
    this.onTable(0);
  ...
  getNextNumberSequence():void{
    this.tokenStorageService.getNextNumberSequence('Lab Bill').subscribe(
      data => {
...
tokensAreLoading_table = false;
  ...
  addAddress() {
    ...
    this.getParticularsList(this.DetailsList.length-1)
  }
