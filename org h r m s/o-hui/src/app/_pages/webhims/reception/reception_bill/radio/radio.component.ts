...
@Input()
  ...
  ngOnInit(): void {
    this.titleService.setTitle("OHIMS | Radio Bill");
    this.tokenStorageService.setSessionPrivileges('hm_1_2_2');
    window.scrollTo(0, 0);
    this.onTable(0);
  ...
  getNextNumberSequence():void{
    this.tokenStorageService.getNextNumberSequence('Radio Bill').subscribe(
      data => {
