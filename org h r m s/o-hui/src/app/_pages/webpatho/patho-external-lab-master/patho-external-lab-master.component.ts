...
@Component({
  selector: 'app-patho-external-lab-master',
  templateUrl: './patho-external-lab-master.component.html',
  styleUrls: ['./patho-external-lab-master.component.css']
})
export class PathoExternalLabMasterComponent implements OnInit {

  constructor(
    private service: PathoExternalLabMasterService,
    ...
    ngOnInit(): void {
      this.tokenStorageService.setSessionPrivileges('pm_3_5');
      window.scrollTo(0, 0);
      this.onTable();
    }
