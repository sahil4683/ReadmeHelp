...
@Component({
  selector: 'app-patho-format-test-master',
  templateUrl: './patho-format-test-master.component.html',
  styleUrls: ['./patho-format-test-master.component.css']
})
export class PathoFormatTestMasterComponent implements OnInit {

  constructor(
    private service: PathoFormatTestMasterService,
    ...
    ngOnInit(): void {
      this.tokenStorageService.setSessionPrivileges('pm_3_11');
      window.scrollTo(0, 0);
      this.onTable();
    }
