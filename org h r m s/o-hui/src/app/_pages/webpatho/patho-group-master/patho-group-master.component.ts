...
@Component({
  selector: 'app-patho-group-master',
  templateUrl: './patho-group-master.component.html',
  styleUrls: ['./patho-group-master.component.css'],
})
export class PathoGroupMasterComponent implements OnInit {
  constructor(
    private service: PathoGroupMasterService,
