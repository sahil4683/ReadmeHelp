...
import {PathoLisMasterService} from 'src/app/_service/webpatho/patho-lis-master.service'
import { ComponentReloadService } from 'src/app/_helpers/component-reload.service';

@Component({
  selector: 'app-patho-lis-master',
  templateUrl: './patho-lis-master.component.html',
  styleUrls: ['./patho-lis-master.component.css']
})
export class PathoLisMasterComponent implements OnInit {

  constructor(
    private service: PathoLisMasterService,
    ...
    ngOnInit(): void {
      this.tokenStorageService.setSessionPrivileges('pm_3_7');
      window.scrollTo(0, 0);
      this.onTable();
    }
