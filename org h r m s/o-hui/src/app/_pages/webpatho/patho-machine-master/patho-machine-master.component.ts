...
@Component({
  selector: 'app-patho-machine-master',
  templateUrl: './patho-machine-master.component.html',
  styleUrls: ['./patho-machine-master.component.css']
})
export class PathoMachineMasterComponent implements OnInit {

  constructor(
    private service: PathoMachineMasterService,
    ...
    ngOnInit(): void {
      this.tokenStorageService.setSessionPrivileges('pm_3_8');
      window.scrollTo(0, 0);
      this.onTable();
    }
