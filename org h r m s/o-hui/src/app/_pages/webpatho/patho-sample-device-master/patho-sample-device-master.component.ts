...
@Component({
  selector: 'app-patho-sample-device-master',
  templateUrl: './patho-sample-device-master.component.html',
  styleUrls: ['./patho-sample-device-master.component.css']
})
export class PathoSampleDeviceMasterComponent implements OnInit {

  constructor(
    private service: PathoSampleDeviceMasterService,
    ...
    ngOnInit(): void {
      this.tokenStorageService.setSessionPrivileges('pm_3_9');
      window.scrollTo(0, 0);
      this.onTable();
    }
