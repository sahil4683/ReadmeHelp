...
const API_URL = environment.apiUrl + '/subdepartment_master/';
const httpOptions = {
...
export class SubdepartmentService {
  ...
  getSubDepartmentByDepartment(department): Observable<any> {
    return this.http.get(API_URL + 'getSubDepartmentByDepartment/' + department, { responseType: 'json' });
  }
