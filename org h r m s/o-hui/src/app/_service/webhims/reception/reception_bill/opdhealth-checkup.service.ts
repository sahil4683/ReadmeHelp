...
const API_URL = environment.apiUrl+"/reception-bill-opdhealth_checkup/";
const httpOptions = {
...
export class OpdhealthCheckupService {
  ...
  filterUhidNameBillNo(searchtext): Observable<any> {
    return this.http.get(API_URL + 'filterUhidNameBillNo/'+searchtext, { responseType: 'json' });
  }
